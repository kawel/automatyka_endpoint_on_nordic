...
static uint32_t internal_observer_notify(coap_resource_t * p_resource)
{
    ...
    while (coap_observe_server_next_get(&p_observer, p_observer, p_resource) != (NRF_ERROR_NOT_FOUND))
    {
        // Generate a message.
