...
#define COAP_TRC(...)  NRF_LOG_INTERNAL_INFO(__VA_ARGS__)                               /**< Used for getting trace of execution in the module. */
#define COAP_ERR(...)  NRF_LOG_INTERNAL_ERROR(__VA_ARGS__)                               /**< Used for logging errors in the module. */
